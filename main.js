...
let runningTime = document.getElementById("starts");
let remainTime = 5;
...
function rulesAppear(){
    ...
    function timer(){
        runningTime.textContent = `${remainTime} seconds`;
    ...
    const timeRunning = setInterval(timer ,1000)
}
...
// make rulesbox disappear
// setTimeout(questionAppear, 11010);
// setTimeout(rulesAppear,5000);
// setTimeout(rulesAppear,11000);
